      ...
      <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
        <div className="flex items-center gap-2 text-xs text-[var(--text-muted)]">
          ...
          <select
            ...
            className="rounded-lg border border-[var(--border)] bg-[var(--surface)] px-2 py-1.5 text-[var(--text-primary)]"
          >
        ...
        <div className="flex items-center gap-3">
          {loading && <LoaderCircle size={16} className="animate-spin text-[var(--accent)]" />}
          <span className="text-xs text-[var(--text-muted)]">
            Página {(page + 1).toLocaleString('es-PE')} de {totalPages.toLocaleString('es-PE')}
          </span>
          <button type="button" disabled={loading || page === 0} onClick={() => onPageChange(page - 1)} className="rounded-lg border border-[var(--border)] p-2 text-[var(--text-primary)] disabled:opacity-40">
            <ChevronLeft size={16} />
          </button>
          <button type="button" disabled={loading || page + 1 >= totalPages} onClick={() => onPageChange(page + 1)} className="rounded-lg border border-[var(--border)] p-2 text-[var(--text-primary)] disabled:opacity-40">
